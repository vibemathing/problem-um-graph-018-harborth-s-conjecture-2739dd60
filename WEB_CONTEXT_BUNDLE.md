...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-graph-018-harborth-s-conjecture-2739dd60-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GRAPH-018"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-graph-018-harborth-s-conjecture-2739dd60-v1",
      "problem_contract_sha256": "0ec8056d6a64c7972e94d5a60de37d1e7b7feae38a13bc93332246bfd770cada",
      "problem_id": "problem:um-graph-018-harborth-s-conjecture-2739dd60",
      "route_id": "route:um-graph-018-harborth-s-conjecture-2739dd60-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-graph-018-harborth-s-conjecture-2739dd60-source-fidelity-01",
      "graph_id": "graph:um-graph-018-harborth-s-conjecture-2739dd60-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-graph-018-harborth-s-conjecture-2739dd60-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-graph-018-harborth-s-conjecture-2739dd60-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Can every planar graph be drawn with integer edge lengths?"
          },
          "statement_sha256": "0cf7856fb576f8b642243cee9db30e2b858cd8c8b4a4ff6edf6cc299b1c5d579"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-graph-018-harborth-s-conjecture-2739dd60-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-graph-018-harborth-s-conjecture-2739dd60-root",
      "route_id": "route:um-graph-018-harborth-s-conjecture-2739dd60-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-graph-018-c35818b497ce",
        "url": "https://www.unsolvedmath.com/problems/GRAPH-018"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
